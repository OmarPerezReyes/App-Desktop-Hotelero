 ...
 * @author omarperez
 */
public class CRUDTipoHabitacion extends javax.swing.JPanel {

    private final ModeloTipoHabitacion modelo;

    public CRUDTipoHabitacion() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" CRUD Tipos de Habitación");
        ...
        jTableDatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Precio", "Capacidad", "Check In", "Check Out"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CRUDTipoHabitacion().setVisible(true);
            }
        });
    }
    ...
    private void modificar() {
        ...
        if (filaSeleccionada != -1) {
            ...
            int id = (int) jTableDatos.getValueAt(filaSeleccionada, 0);
            double precio = (double) jTableDatos.getValueAt(filaSeleccionada, 1);
            int cantidad = (int) jTableDatos.getValueAt(filaSeleccionada, 2);
            Time checkin = (Time) jTableDatos.getValueAt(filaSeleccionada, 3);
            Time checkout = (Time) jTableDatos.getValueAt(filaSeleccionada, 4);

            // Crear un objeto TipoHabitacion con los datos obtenidos
            TipoHabitacion obj = new TipoHabitacion(id, precio, cantidad,checkin, checkout);

            // Crear y mostrar el formulario NewTipoHabitacion con los datos del TipoHabitacion
            NewTipoHabitacion newForm = new NewTipoHabitacion();
