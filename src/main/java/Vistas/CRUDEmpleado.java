...
public class CRUDEmpleado extends javax.swing.JFrame {
    ...
    private final ModeloEmpleado modelo;
    ...
    private void cargarDatosEnTabla() {
        try {
            List<Empleado> datos = modelo.obtenerTodos();
    ...
    private void buscar() {
        try {
            ...
            List<Empleado> datos = modelo.buscar(textoBuscar);
    ...
    private void modificar() {
        ...
        if (filaSeleccionada != -1) {
            ...
            Empleado obj = new Empleado(id, nombre, apellido, tipoDocIdentidad, numDocIdentidad,
                    telefono, email, contraseña, sexo, fechaNacimiento);

            // Crear y mostrar el formulario NewEmpleado con los datos del empleado
            NewEmpleado newForm = new NewEmpleado();
