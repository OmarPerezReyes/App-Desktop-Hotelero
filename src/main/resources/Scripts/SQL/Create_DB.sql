...
CREATE TABLE RESERVA (
    id_reserva INTEGER PRIMARY KEY NOT NULL IDENTITY(1,1),
...
CREATE TABLE DETALLE_RESERVA(
    id_det_reserva INTEGER PRIMARY KEY NOT NULL IDENTITY(1,1),
...
CREATE TABLE BOLETA(
    id_pago INTEGER PRIMARY KEY NOT NULL IDENTITY(1,1),
...
CREATE TABLE ACOMPAÑANTE(
    id_acompañante INTEGER PRIMARY KEY NOT NULL IDENTITY(1,1),
    id_det_reserva INTEGER NOT NULL,
    nombre VARCHAR(50) NOT NULL,
    apellido VARCHAR(50) NOT NULL,
    FOREIGN KEY (id_det_reserva) REFERENCES DETALLE_RESERVA(id_det_reserva)
